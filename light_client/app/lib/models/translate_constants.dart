class translateConstants {
  Map<String, String> translation = {
    ...
    "Erreur lors de la connexion. Mauvais nom d'utilisateur et/ou mot de passe ou compte deja connecté. Veuillez recommencer":"Error while connecting. Wrong username and/or password or account already logged in. Please try again",
    ...
    //sign_page
    "Votre compte a été créé avec succés": "Your account has been successfully created",
    "Erreur lors de la création du compte. Nom d'utilisateur deja utilisé. Veuillez recommencer.":"Error creating account. Username already in use. Please try again.",
    'Création de compte': "Account creation",
    "Nom d'utilisateur": "Username",
    "Nom d'utilisateur requis": "Username required",
    "Un nom d'utilisateur doit au moins contenir 5 caractéres.": "A username must contain at least 5 characters.",
    "Un nom d'utilisateur ne doit contenir que des lettres ou des chiffres": "A username must only contain letters or numbers",
    ...
    "Un mot de passe doit contenir au minimum 6 caractéres.": "A password must contain at least 6 characters.",
    "Retapez votre mot de passe": "Enter your password again",
    "Le mot de passe écrit ne correspond pas": "The entered password does not match",
    ...
    "Entrez une réponse à la question de sécurité": "Enter an answer to the security question",
    ...
    "Plusieurs joueurs sont en train d'écrire ...": "Several players are writing...",
    ...
    "Choississez une icône ou importer une image": "Choose an icon or import an image",
    ...
    "Le nombre de joueurs humains minimum est de 2.": "The minimum number of human players is 2.",
    "Le nombre de joueurs humains maximum est de 4.": "The maximum number of human players is 4.",
    ...
    "Mot de passe de partie publique (optionnel)": "Public game password (optional)",
    ...
    "Erreur : les mots crées sont invalides": "Error: the created words are invalid",
    "Commande impossible a réaliser : le nombre de lettres dans la réserve est insuffisant": "The task can not be executed: the number of letters in the reserve is insufficient",
    'Page de jeu': "Game page",

    //home_page
    "Vous avez été déconnecté avec succés":"You have been successfully logged out",
    ...
    "Bien joué, vous avez fini le mode d'entraînement orthographe !":"Well done, you've finished orthography mode!",


    //password_recovering_page
    "Ce nom d'utilisateur n'existe pas":"This username does not exist",
    "Modification du mot de passe non-autorisée":"Unauthorized password change",
    "Retour": "Back",
    ...
    "Veuillez entrer un nouvel utilisateur ou avatar": "Please enter a new user or avatar",
    ...
    "Joueurs restants pour démarrer la partie:":"Players left to start the game:",
    "Lancer Partie": "Start game",
    "Annuler Partie": "Cancel game",
    "Demande d'acceptation": "Approval request",
    "essaye de rejoindre la partie. Accepter ou rejeter le joueur?": "try to join the game. Accept or reject player?",
    "Rejeter": "Reject",
    "Accepter": "Accept",
