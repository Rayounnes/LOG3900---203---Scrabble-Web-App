...
class _TimerPageState extends State<TimerPage> {
  ...
  void handleSockets() {
    ...
    getIt<SocketService>().on('send-info-to-panel', (infos) {
      setState(() {
        players = List<GamePlayerInfos>.from(infos['players']
